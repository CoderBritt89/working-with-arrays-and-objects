...
let bobsTotal = purchases.filter((elem, index, array)=> {return elem.owner === 'Bob'})
...
// CORRECT AS WELL - CLEANER CODE
// let bobsTotal = purchases.filter((elem, index, array)=> elem.owner === 'Bob')
